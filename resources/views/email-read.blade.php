    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="email-leftbar card">
                ...
                <div class="mt-2">
                    <a href="#" class="media">
                        <img class="d-flex me-3 rounded-circle" src="{{ URL::asset('/assets/images/users/avatar-2.jpg') }}"
                    ...
                    <a href="#" class="media">
                        <img class="d-flex me-3 rounded-circle" src="{{ URL::asset('/assets/images/users/avatar-3.jpg') }}"
                            alt="Generic placeholder image" height="36">
                        <div class="media-body chat-user-box">
                    ...
                    <a href="#" class="media">
                        <img class="d-flex me-3 rounded-circle" src="{{ URL::asset('/assets/images/users/avatar-4.jpg') }}"
                            alt="Generic placeholder image" height="36">
                        <div class="media-body chat-user-box">
                    ...
                    <a href="#" class="media">
                        <img class="d-flex me-3 rounded-circle" src="{{ URL::asset('/assets/images/users/avatar-6.jpg') }}"
                            alt="Generic placeholder image" height="36">
                        <div class="media-body chat-user-box">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="media mb-4">
                            <img class="d-flex me-3 rounded-circle avatar-sm" src="{{ URL::asset('/assets/images/users/avatar-2.jpg') }}"
