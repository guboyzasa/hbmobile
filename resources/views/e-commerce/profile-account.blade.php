                                                ...
                                                <tfoot>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <p>ชื่อบัญชี : {{ $order->paymentMethod->bank_account_name }}
                                                            </p>
                                                            <p>เลขที่บัญชี : {{ $order->paymentMethod->bank_account_no }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                ...
                                <form action="#!" class="form-horizontal row" method="POST" id="form-customer">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <button type="submit" id="store-btn-hidden"
                                                class="d-none">save</button>
                                        </div>
                                    </div>
                                </form><!-- /.form -->
                            </div><!-- ./tab-profile -->
                                ...
                                <form action="#!" class="form-horizontal row" method="POST" id="form-bill-customer">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <button type="button" id="store-btn-bill"
                                            class="btn btn-primary w-100">บันทึก</button>
                                        <button type="submit" id="store-btn-bill-hidden"
                                            class="d-none">save</button>
                                    </div>
                                </form>
                            </div>
