			...
			<div class="row align-items-center mb-5">
				<div class="col-lg-4">
					...
					<p class="subtitle description">
						<i class='bx bxs-circle' ></i> จำหน่ายแบตเตอรี่มือถือหลากหลายรุ่น สายชาร์จ อุปกรณ์ อะไหล่มือถือสมาร์ทโฟน เครื่องมือช่างทุกชนิด
					</p>
					<p class="subtitle description">
				...
				<div class="col-lg-8">
					<div class="image">
						<img src='{{ URL::asset("get-content/images/about/1.jpg") }}' class="img-fluid" alt="">
						<!-- <div class="caption">
							<span>Our</span>
							<span>Office</span>
						</div> -->
