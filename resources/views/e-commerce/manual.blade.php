...
@section('css')
<meta property="og:title" content="HB Mobile|เฮียบอยโมบาย - ขั้นตอนต่างๆ" />
<meta property="og:image" content="{{ URL::asset('/assets/dist/images/img-link/manual.png') }}" />
            ...
            <div class="card-body ">
                <div class="container">
                    <div class="custom-accordion flex-column" id="manual-detail" role="tablist"
                        ...
                        <div class="card card-default shadow-lg" style="border-radius: 5px">
                            ...
                            <div id="last-manual" class="card-collapse collapse" data-parent="#manual-detail">
                                <div class="card-body">
                                    <div class="box table-responsive" style="border-radius: 5px">
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="manual media shadow-lg" style="border-radius: 5px">
                                                    <div class="media-left media-middle">
                                            ...
                                            <div class="col-md-6">
                                                <div class="manual media shadow-lg" style="border-radius: 5px">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <p>เลือกขนาด ประเภท จำนวนสินค้า และกดสั่งซื้อผ่านหน้าเว็บไซต์
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                ...
                </div><!-- /.container 1.ขั้นตอนการสั่งซื้อสินค้า -->
                ...
                <div class="container">
                        ...
                        <div class="custom-accordion flex-column" id="manuals-detail" role="tablist"
                            ...
                            <div class="card card-default shadow-lg" style="border-radius: 5px">
                                <div class="card-header cursor-pointer" data-toggle="collapse"
                                    data-target="#last-manuals" aria-expanded="true" style="border-radius: 5px">
                                    <div class="media-left media-middle">
                                                ...
                                                <div class="col-md-7">
                                                    <div class="manual media shadow-lg" style="border-radius: 5px">
                                                        ...
                                                        <div class="media-body">
                                                            ...
                                                            <p>เฮียบอยโมบายเซอร์วิส 1 หมู่ 6 บ.บ่อทอง ต.ขามป้อม อ.พระยืน
                                                                จ.ขอนแก่น
                                                                40320
                                                            </p>
                                                        </div>
                                                ...
                                                <div class="col-md-5">
                                                    <div class="manual media shadow-lg" style="border-radius: 5px">
                                                        ...
                                                        <div class="media-body">
                                                            ...
                                                            <p style="color:red;"> *ใช้เบอร์ที่ติดต่อได้ สมัครเท่านั้น
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="manual media shadow-lg" style="border-radius: 5px">
                                                        ...
                                                        <div class="media-body">
                                                            ...
                                                            <p>ร้านจะทำการแจ้งค่าใช้จ่ายทางแชท
                                                                และขอที่อยู่เพื่อส่งเครื่องกลับ </p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div><!-- /.row -->
                    ...
                    </div><!-- /.container 2.ขั้นตอนการส่งเครื่องซ่อม -->
                            ...
                            <div class="custom-accordion flex-column" id="manual-register-detail" role="tablist"
                                ...
                                <div class="card card-default shadow-lg" style="border-radius: 5px">
                                    ...
                                    <div id="last-manual-register" class="card-collapse collapse"
                                        data-parent="#manual-register-detail">
                                        <div class="card-body">
                                            <div class="box table-responsive" style="border-radius: 5px">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="manual media shadow-lg" style="border-radius: 5px">
                                                            ...
                                                            <div class="media-body">
                                                                ...
                                                                <p>1.1<a href="{{ route('register-page') }}"
                                                                        style="color:red;">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="manual media shadow-lg" style="border-radius: 5px">
                                                            ...
                                                            <div class="media-body">
                                                                ...
                                                                <p>2.1 ชื่อ-สกุล</p>
                                                                <p>2.2 <a style="color:red;">เบอร์โทรศัพท์
                                                                        ที่ติดต่อได้</a></p>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="manual media shadow-lg" style="border-radius: 5px">
                                                            ...
                                                            <div class="media-body">
                                                                ...
                                                                {{-- <p>3.1 ทำการ login</p>
                                                                <p>3.2 <a
                                                                        style="color:red;">แก้ไขข้อมูลส่วนตัวให้เรียบร้อย</a>
                                                                </p>
                                                                <p>3.3 <a
                                                                        style="color:red;">แก้ไขที่อยู่จัดส่งให้เรียบร้อย</a>
                                                                </p> --}}
                                                            </div>
                                                        </div>
                                                    </div>
                    ...
                    </div><!-- /.container 3.ขั้นตอนการสมัครสมาชิก -->
                    ...
                    <div class="container">
                            ...
                            <div class="custom-accordion flex-column" id="manual-password-detail" role="tablist"
                                ...
                                <div class="card card-default shadow-lg" style="border-radius: 5px">
                                    ...
                                    <div id="last-manual-password" class="card-collapse collapse"
                                        data-parent="#manual-password-detail">
                                        <div class="card-body">
                                            <div class="box table-responsive" style="border-radius: 5px">
                                                <div class="row">
                                                    <div class="col-md-5">
                                                        <div class="manual media shadow-lg" style="border-radius: 5px">
                                                            ...
                                                            <div class="media-body">
                                                                <h3 class="media-heading">1. คลิกที่ลิ้งด้านล่าง</h3>
                                                                <p>1.1<a href="{{ route('verify-username') }}"
                                                                        style="color:red;">
                        ...
                        </div><!-- /.container 4.ขั้นตอนการเปลี่ยนรหัสผ่าน -->
                    </div>
                </div>
            </div>
</section><!-- /.manuals -->
