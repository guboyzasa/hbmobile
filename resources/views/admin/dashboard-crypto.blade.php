            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <p class="text-muted mb-4"><i
                                    class="mdi mdi-bitcoin h2 text-warning align-middle mb-0 me-3"></i> Bitcoin </p>
                ...
                <div class="col-sm-4">
                    <div class="card">
                        <div class="card-body">
                            <p class="text-muted mb-4"><i
                                    class="mdi mdi-ethereum h2 text-primary align-middle mb-0 me-3"></i> Ethereum </p>
                    ...
                    <ul class="list-group" data-simplebar style="max-height: 390px;">
                            ...
                            <div class="media">
                                <div class="avatar-xs me-3">
                                    <span class="avatar-title rounded-circle bg-light">
                                        <img src="{{ URL::asset('/assets/images/companies/img-1.png') }}" alt="" height="18">
                                    </span>
                                </div>
                        ...
                        <li class="list-group-item border-0">
                            <div class="media">
                                <div class="avatar-xs me-3">
                                    <span class="avatar-title rounded-circle bg-light">
                                        <img src="{{ URL::asset('/assets/images/companies/img-2.png') }}" alt="" height="18">
                                    </span>
                                </div>
                                <div class="media-body">
                        ...
                        <li class="list-group-item border-0">
                            <div class="media">
                                <div class="avatar-xs me-3">
                                    <span class="avatar-title rounded-circle bg-light">
                                        <img src="{{ URL::asset('/assets/images/companies/img-3.png') }}" alt="" height="18">
                                    </span>
                                </div>
                                <div class="media-body">
