...
@section('title') โปรไฟล์ | Admin - HB Mobile Services  @endsection
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <table id="order_table" class="table table-bordered dt-responsive  w-100">
                                                    <thead>
                                                        <tr>
                                                            <th>เลขออเดอร์</th>
                                                            <th>ชื่อลูกค้า</th>
    ...
    {{-- <div class="row">
        ...
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                    <button type="button" class="btn btn-sm btn-warning" onclick='showInfoAddress({{ $customerAddress }})'  style="float:right;"><i class="bx bx-pencil"></i> แก้ไข </button>
                    <h4 class="card-title mb-4"> ข้อมูลที่อยู่สำหรับจัดส่ง </h4>
        ...
        <div class="col-6">
            <div class="card">
                <div class="card-body">
                    <button type="button" class="btn btn-sm btn-warning" onclick='showInfoBillAddress({{ $customerBillAddress }})'  style="float:right;"><i class="bx bx-pencil"></i> แก้ไข </button>
                    <h4 class="card-title mb-4"> ข้อมูลที่อยู่สำหรับออกบิล </h4>
    ...
    <div class="modal fade update-profile" id="simpleModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.customer.update') }}" class="form-horizontal" method="POST" id="customer-form">
                        @csrf
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('admin.customer.update-address') }}" class="form-horizontal" method="POST" id="customer-address-form">
                        @csrf
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('admin.customer.update-bill-address') }}" class="form-horizontal" method="POST" id="customer-bill-form">
                        @csrf
                        <input type="hidden" name="customer_id" value="{{ $customer->id }}">
...
<script>
                ...
                "columns": [
...

                    {
                        ...
                        "render": function (data, type, full) {
                            ...
                            <a  href="/admin/customer/profile/${data}" class="btn btn-sm btn-info" ><i class="bx bx-pencil"></i> ดูรายละเอียด </button>
        ...
        $(".province").change(function () {
            ...
            $.post("{{  route('admin.customer.get-district')  }}", data = {
                    _token: '{{ csrf_token() }}',
        ...
        $(".district").change(function () {
            ...
            $.post("{{  route('admin.customer.get-sub-district')  }}", data = {
                    _token: '{{ csrf_token() }}',
        ...
        $(".sub_district").change(function () {
            ...
            $.post("{{  route('admin.customer.get-zipcode')  }}", data = {
                    _token: '{{ csrf_token() }}',
        ...
        $('#warranty_table').ready(function () {
            ...
            warranty = $('#warranty_table').DataTable({
                ...
                "ajax": {
                    "url": `/admin/warranty/warranty-customer/${cus_id}`,
                    "method": "POST",
                    "data": {
                        "_token": "{{ csrf_token()}}",
                    },
        ...
        $('#order_table').ready(function () {
            ...
            order_table = $('#order_table').DataTable({
                ...
                "ajax": {
                    "url": `/admin/order/order-customer/${cus_id}`,
                    "method": "POST",
                    "data": {
                        "_token": "{{ csrf_token()}}",
                    },
...

                    {
                        ...
                        "render": function (data, type, full) {
                            ...
                            switch (data) {
                                ...
                                case 2:
                                    text = `<span class="badge badge-soft-primary"><i class="bx bx-check"></i> ยืนยันการชำระเงิน </span>`;
                                    break;
                                ...
                                case 5:
                                    text = `<span class="badge rounded-pill bg-danger"><i class="bx bx-error-alt"></i> จัดส่งไม่สำเร็จ </span>`;
                                    break;

                                case 6:
                                    text = `<span class="badge rounded-pill bg-danger" ><i class="bx bx-error-alt"></i>  ยกเลิกรายการ </span>`;
                                    break;
