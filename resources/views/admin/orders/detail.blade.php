                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 text-sm-end">
                            <address class="mt-2 mt-sm-0">
                                ...
                                ต. {{ @$order->orderDeliveryAddress->sub_district }}, อ.
                                {{ @$order->orderDeliveryAddress->district }}<br>
                                จ. {{ @$order->orderDeliveryAddress->province }},
                                {{ @$order->orderDeliveryAddress->zipcode }}<br>
                                ...
                                @if ($order->orderDeliveryAddress->note)
                                    <span style="color: red;">หมายเหตุ :
                                        {{ @$order->orderDeliveryAddress->note }}</span><br>
                                @endif
                            </address>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-sm-end">
                            <address class="mt-2 mt-sm-0">
                                ...
                                ต. {{ @$order->orderBillAddress->sub_district }},
                                อ. {{ @$order->orderBillAddress->district }}<br>
                                จ. {{ @$order->orderBillAddress->province }},
                                {{ @$order->orderBillAddress->zipcode }}<br>
                            ...
                            <address>
                                ...
                                @if ($order->orderPayment && $order->orderPayment->payment_slip)
                                    <a style="text-align:center;" href="#"
                                        onclick='showImg("{{ $order->orderPayment->payment_slip }}")'>
                                        <img src="{{ URL::asset('get-content/' . $order->orderPayment->payment_slip) }}"
                                            width="100%" class="css image img grid-item"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="border-0 text-end">
                                        <h4 class="m-0 text-success">฿ {{ number_format(@$order->total_amount, 2) }}
                                        </h4>
                                    </td>
                                </tr>
                            </tbody>
                                            ...
                                            <div class="form-check form-check-secondary">
                                                @if ($order->status == 0)
                                                    <input class="form-check-input" type="radio" value="0"
                                                        name="status" id="formCheckcolor0" required checked>
                                                @else
                                                    <input class="form-check-input" type="radio" value="0"
                                                        name="status" id="formCheckcolor0" required>
                                                @endif
                                                <label classz="form-check-label" for="formCheckcolor0"> รออัพโหลด </label>
                                            </div>
                                            <div class="form-check form-check-warning">
                                                @if ($order->status == 1)
                                                    <input class="form-check-input" type="radio" value="1"
                                                        name="status" id="formCheckcolor1" required checked>
                                                @else
                                                    <input class="form-check-input" type="radio" value="1"
                                                        name="status" id="formCheckcolor1" required>
                                                @endif
                                                <label classz="form-check-label" for="formCheckcolor1"> อัพโหลดสลิปแล้ว
                                                </label>
                                            </div>
                                            <div class="form-check form-check-primary">
                                                @if ($order->status == 2)
                                                    <input class="form-check-input" type="radio" value="2"
                                                        name="status" id="formCheckcolor2" required checked>
                                                @else
                                                    <input class="form-check-input" type="radio" value="2"
                                                        name="status" id="formCheckcolor2" required>
                                                @endif
                                                <label classz="form-check-label" for="formCheckcolor2"> ยืนยันการชำระเงิน
                                                </label>
                                            </div>
                                            <div class="form-check form-check-info">
                                                @if ($order->status == 3)
                                                    <input class="form-check-input" type="radio" value="3"
                                                        name="status" id="formCheckcolor3" required checked>
                                                @else
                                                    <input class="form-check-input" type="radio" value="3"
                                                        name="status" id="formCheckcolor3" required>
                                                @endif
                                                <label classz="form-check-label" for="formCheckcolor3"> กำลังแพ็คสินค้า
                                                </label>
                                            </div>
                                            <div class="form-check form-check-success">
                                                @if ($order->status == 4)
                                                    <input class="form-check-input" type="radio" value="4"
                                                        name="status" id="formCheckcolor4" required checked>
                                                @else
                                                    <input class="form-check-input" type="radio" value="4"
                                                        name="status" id="formCheckcolor4" required>
                                                @endif
                                                <label classz="form-check-label" for="formCheckcolor4"> จัดส่งแล้ว
                                                </label>
                                            </div>
                                            <div class="form-check form-check-danger">
                                                @if ($order->status == 5)
                                                    <input class="form-check-input" type="radio" value="5"
                                                        name="status" id="formCheckcolor5" required checked>
                                                @else
                                                    <input class="form-check-input" type="radio" value="5"
                                                        name="status" id="formCheckcolor5" required>
                                                @endif
                                                <label classz="form-check-label" for="formCheckcolor5"> จัดส่งไม่สำเร็จ
                                                </label>
                                            </div>
                                            ...
                                            <div class="form-check form-check-danger">
                                                @if ($order->status == 6)
                                                    <input class="form-check-input" type="radio" value="6"
                                                        name="status" id="formCheckcolor6" required checked>
                                                @else
                                                    <input class="form-check-input" type="radio" value="6"
                                                        name="status" id="formCheckcolor6" required>
                                                @endif
                                                <label classz="form-check-label" for="formCheckcolor6"> ยกเลิกรายการ
                                                </label>
                                            </div>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <img id="output1" max-width="400" style="max-height: 560px;"
