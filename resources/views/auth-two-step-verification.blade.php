                                            ...
                                            <div class="row">
                                                <div class="col-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control form-control-lg text-center" id="digit1" maxLength="1">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control form-control-lg text-center" id="digit2" maxLength="1">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control form-control-lg text-center" id="digit3" maxLength="1">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control form-control-lg text-center"  id="digit4" maxLength="1">
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
