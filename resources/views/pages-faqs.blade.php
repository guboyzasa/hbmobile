                            ...
                            <div class="tab-pane fade show active" id="v-pills-gen-ques" role="tabpanel"
                                ...
                                <div class="faq-box media mb-4">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="text-muted">New common language will be more simple and regular than the
                                ...
                                <div class="faq-box media mb-4">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="text-muted">Their separate existence is a myth. For science, music, sport,
                                            etc, Europe uses the same vocabulary.</p>
                                    </div>
                                </div>
                                <div class="faq-box media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="text-muted">To an English person, it will seem like simplified English, as
                                            a skeptical Cambridge friend of mine told me what Occidental</p>
                                    </div>
                                </div>
                            </div>
