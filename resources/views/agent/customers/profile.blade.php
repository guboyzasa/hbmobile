...
@section('title') ข้อมูลลูกค้า | Agent - DissingThailand @endsection
...
<script>
        ...
        //         ],
        //         "ajax": {
        //             "url": `/agent-member/order/order-customer/${cus_id}`,
        //             "method": "POST",
        //             "data": {
        //                 "_token": "{{ csrf_token()}}",
        //             },
        ...
        //                     <a type="button" class="btn btn-sm btn-info" href="/agent-member/order/${data}"><i class="bx bx-search-alt-2"></i> </a>
