                        ...
                        <div class="col-xl-2">
                            <div class="control-group" id="toastTypeGroup">
                                <div class="controls mb-4">
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" name="toast-type-radio"
                                            id="toast-type-radio1" value="success" checked>
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" name="toast-type-radio"
                                            id="toast-type-radio2" value="info">
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" name="toast-type-radio"
                                            id="toast-type-radio3" value="warning">
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" name="toast-type-radio"
                                            id="toast-type-radio4" value="error">
                            ...
                            <div class="control-group" id="positionGroup">
                                <div class="controls mb-4">
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" name="positions-radio"
                                            id="positions-radio1" value="toast-top-right" checked>
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" name="positions-radio"
                                            id="positions-radio2" value="toast-bottom-right">
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" name="positions-radio"
                                            id="positions-radio3" value="toast-bottom-left">
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" name="positions-radio"
                                            id="positions-radio4" value="toast-top-left">
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" name="positions-radio"
                                            id="positions-radio5" value="toast-top-full-width">
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" name="positions-radio"
                                            id="positions-radio6" value="toast-bottom-full-width">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="positions-radio"
                                            id="positions-radio7" value="toast-top-center">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="positions-radio"
                                            id="positions-radio8" value="toast-bottom-center">
