                ...
                <div class="card-body">
                    <div class="row">
                                    ...
                                    <div class="col-md-2 col-sm-3 col-4">
                                        <div class="nav flex-column nav-pills " id="v-pills-tab" role="tablist"
                                            ...
                                            <a class="nav-link" id="product-2-tab" data-bs-toggle="pill" href="#product-2"
                                                ...
                                                <img src="{{ URL::asset('/assets/images/product/img-8.png') }}" alt=""
                                                    class="img-fluid mx-auto d-block rounded">
                                            </a>
                        ...
                        <div class="col-xl-6">
                            <div class="mt-4 mt-xl-3">
                                ...
                                <h5 class="mb-4">Price : <span class="text-muted me-2"><del>$240 USD</del></span> <b>$225
                                        USD</b></h5>
                                ...
                                <div class="product-color">
                                    ...
                                    <a href="#" class="active">
                                        <div class="product-color-item border rounded">
                                            <img src="{{ URL::asset('/assets/images/product/img-7.png') }}" alt="" class="avatar-md">
                                        </div>
                                        <p>Black</p>
                                    </a>
                                    <a href="#">
                    ...
                    <div class="mt-5">
                        ...
                        <div class="media py-3 border-bottom">
                            <img src="{{ URL::asset('/assets/images/users/avatar-2.jpg') }}" class="avatar-xs me-3 rounded-circle" alt="img" />
                            <div class="media-body">
                                ...
                                <div class="text-muted font-size-12"><i class="far fa-calendar-alt text-primary me-1"></i> 5
                                    hrs ago</div>
                            </div>
                        </div>
                        <div class="media py-3 border-bottom">
                            <img src="{{ URL::asset('/assets/images/users/avatar-4.jpg') }}" class="avatar-xs me-3 rounded-circle" alt="img" />
                            <div class="media-body">
                                ...
                                <div class="media mt-4">
                                    <img src="{{ URL::asset('/assets/images/users/avatar-5.jpg') }}" class="avatar-xs me-3 rounded-circle"
                                        alt="img" />
                                    <div class="media-body">
                                        ...
                                        <div class="text-muted font-size-12"><i
                                                class="far fa-calendar-alt text-primary me-1"></i> 08 Oct, 2019</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-8">
                                        <div class="text-center text-md-start pt-3 pt-md-0">
                                            <h5 class="text-truncate"><a href="#" class="text-dark">Wirless Headphone</a>
                                            </h5>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-8">
                                        <div class="text-center text-md-start pt-3 pt-md-0">
                                            <h5 class="text-truncate"><a href="#" class="text-dark">Phone patterned
                                                    cases</a></h5>
                                            <p class="text-muted mb-4">
                                                <i class="bx bxs-star text-warning"></i>
                                                <i class="bx bxs-star text-warning"></i>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-8">
                                        <div class="text-center text-md-start pt-3 pt-md-0">
                                            ...
                                            <h5 class="text-truncate"><a href="#" class="text-dark">Phone Dark Patterned
                                                    cases</a></h5>
                                            <p class="text-muted mb-4">
                                                <i class="bx bxs-star text-warning"></i>
                                                <i class="bx bxs-star text-warning"></i>
